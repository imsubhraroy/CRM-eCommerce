    ...
    while ($rows = mysqli_fetch_assoc($result1)) {
        ...
        <div class="col-md-2 col-6">
            <div class="card mt-4 mb-4" style="width: 10rem; border:none; ">
                <a href="/<?= $base_path ?>/Product/product_details.php?id=<?php echo $rows['id'] ?>" class="text-reset text-decoration-none"> <img src="../products_Image/<?php echo $file_name; ?>" class="card-img-top" alt=" <?php echo $row['name']; ?>"></a>
                <div class="card-body">

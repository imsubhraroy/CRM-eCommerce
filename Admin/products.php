...
echo '    <a class="btn btn-primary mt-3 mb-4" href="/admin/Add/add-product.php">Add Product</a>   <!-- add product Modal -->
...
if(isset($_REQUEST['view'])){
  ...
  echo '<script> location.href="/admin/view/view-product.php";</script>';
}

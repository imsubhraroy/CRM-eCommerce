...
<div class="pb-4 "> <!--start of the div-->
    ...
    <form class="row g-3" method="POST">
        <div class="col-12">
            <input type="hidden" name="uid" value="<?php if (isset($row['uid'])) {
                                                        echo $row['uid'];
                                                    } ?>">
            <label for="rid" class="form-label">Request ID</label>
            <input type="text" class="form-control" name="rid" placeholder="Request Id" value="<?php if (isset($row['id'])) {
                                                                                                    echo $row['id'];
                                                                                                } ?>" readonly>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input type="text" class="form-control" name="request_desc" placeholder="Request Description" value="<?php if (isset($row['request_desription'])) {
                                                                                                                        echo $row['request_desription'];
                                                                                                                    } ?>">
        </div>
        <div class="col-12">
...
<?php
if (isset($_REQUEST['assign'])) {    //fetching all input field value
    $uid = $_REQUEST['uid'];
    $rid = $_REQUEST['rid'];

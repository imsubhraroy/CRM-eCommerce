...
<section class="jumbotron back-image">
  ...
  <div class="myclass mainHeading">
    <h1 class="text-uppercase text-danger font-weight-bold">Welcome to MeCom</h1>
...
<section class="container">
  ...
  <div class="forservice text-center my-5">
    ...
    <h3 class="fs-1">MeCom Services</h3>
    <p class="">MeCom Services is India’s leading chain of multi-brand Electronics and Electrical service
      workshops offering
